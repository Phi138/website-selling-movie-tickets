...
?>
<table able border="1" cellpadding="5" cellspacing="5" style="border-collapse:collapse;">
echo '<tr><td><i><b>Mã hóa đơn :</i></b><br />' . $row['So_hoa_don'] . '<br />';
        echo '<i><b>Ngay hóa đơn:</b></i>' . $row['Ngay_HD'] . '<br />';
        echo '<i><b>Trị giá : </b></i>' . $row['Tri_gia'] . ' VND ';
</table>
</body>
