...
$result = mysqli_query($conn, $query);
 ...
 echo '<tr>
    ...
    <th width="270">Số chỗ ngồi</th>
    <th width="500">Số Hàng</th>
    <th width="300">Số cột</th>
    <th width="100">Chi tiết ghế</th>
    <th width="100">Sửa</th>
    <th width="100">Xóa</th>
</tr>';
...
if(mysqli_num_rows($result)<>0)
 {   $stt=1;
    ...
    {          echo '<tr>';
             ...
             echo "<td>$rows[3]</td>";
             echo "<td>$rows[4]</td>";
             echo "<td><a href='chitietGhe.php?id=$rows[0]'>Chi tiết ghế</a></td>";
             echo "<td><a href='edit_room.php?id=$rows[0]'>Sửa</a></td>";
             echo "<td><a href='delete_room.php?id=$rows[0]'>Xóa</a></td>";
             echo "</tr>";
                 $stt+=1;
    }
    echo "<p class='tieuDe' align='left'><font face= 'Verdana, Geneva, sans-serif' size='5'><span class='them' align='left' style='font-size: 27px'><a href='add-room.php'>Thêm mới</a></span>DANH SÁCH PHÒNG CHIẾU</font></p>";
 }
 echo "</table>";
